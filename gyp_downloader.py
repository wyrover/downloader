...
sys.path.insert(1, os.path.join(src_dir, 'tools'))
# sys.path.insert(1, os.path.join(src_dir, 'tools', 'generate_shim_headers'))
...
if __name__ == '__main__':
  ...
  if [arg.endswith('.gyp') for arg in args].count(True) == 0:
    args.append(os.path.join(src_dir, 'downloader/downloader.gyp'))
